...
<div id="o-header-2013">
    <div class="w" id="header-2013">
        <div id="logo-2013" class="ld"><a href="http://www.jd.com/" hidefocus="true"><b></b><img src="resources/logo-201305.png" width="270" height="60" alt="京东"></a></div>
        <!--logo end-->
        <div id="search-2013">
        ...
        <div id="filter">
            ...
            <div class="fore1">
                ...
                <div class="pagin pagin-m">
                    <span class="text"><i>当前${pageList.currPage}页</i>/共${pageList.countPage}页</span>
            ...
            <ul class="list-h">
                <c:forEach var="p" items="${pageList.list}">
                    <li pid="${p.pid }">
                        <div class="lh-wrap">
                            <div class="p-img">
                                <a target="_blank" href="afdsaf:8080/item?id=${p.pid }">
